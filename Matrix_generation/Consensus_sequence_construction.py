...
def main():
    ...
    # parser.add_argument('--gtf_file', type=str, default='/home/disk/chengrui/toolfolder/时空参考/mm10_gencodeM13/gencode.vM13.annotation.gtf', help='Path to the GTF file')
    parser.add_argument('--gtf_file', type=str, default='/home/disk/chengrui/toolfolder/Homo_sapiens.GRCh38.99.gtf', help='Path to the GTF file')
