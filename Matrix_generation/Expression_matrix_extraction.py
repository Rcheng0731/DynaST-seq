...
def main(args):
    ...
    sample_folder = f'{args.sample_path}/{args.sample_name}'
    ...
    with pysam.AlignmentFile(f'{sample_folder}/{args.bam_file}', 'rb') as f:
        for r in f.fetch():
...
if __name__ == "__main__":
    ...
    parser.add_argument("--bam_file", help="BAM file name (e.g., Aligned.sortedByCoord.UniqueGene.consensus.sorted.bam.tagST.bam)")
