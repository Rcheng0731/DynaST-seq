...
def main(bam_paths, barcodes, n_threads, max_workers, out_dir, gtf_file):
    ...
    split_bam_res = [value[0] for value in ngs.bam.split_bam(bam_paths, out_dir + "/temp", n=64, n_threads=n_threads, show_progress=True).values()]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sample_name", help="Sample name for the directory")
    ...
    all_conversions_list, all_alignments_list, conversion_counts = main([bam_file], barcodes, n_threads, max_workers, out_dir, gtf_path)
